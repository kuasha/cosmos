...
angular.module('myApp.services', [])
    ...
    .factory('cosmos.cachedloader', ['CosmosService', function(CosmosService) {
        return{
            store : {},
    ...
    .factory('cosmos.settings', ['CosmosService', 'cosmos.cachedloader', function(CosmosService, cachedloader) {
        return{
